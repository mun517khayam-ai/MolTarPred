...
# Read the file
file = '/Users/macbook/chembl/Code/Github_target_prediction/Chembl_36_filter.csv'
df = pd.read_csv(file)
...
output_file_path = '/Users/macbook/chembl/Code/Github_target_prediction/Chembl_36_database.csv'
